...
@mixin oj-fwk-icon-cbsingle-hover-selected-scale($scaleFactor: 1) {
  background-size: calc(1826px * #{$scaleFactor}) calc(52px * #{$scaleFactor});
...
@mixin oj-fwk-icon-pull-to-refresh-10-scale($scaleFactor: 1) {
  background-size: calc(1826px * #{$scaleFactor}) calc(52px * #{$scaleFactor});
  background-position: calc((-678px - 2px) * #{$scaleFactor}) calc((0px - 2px) * #{$scaleFactor});
  width: calc(40px * #{$scaleFactor});
  height: calc(40px * #{$scaleFactor});
}
...
@mixin oj-fwk-icon-pull-to-refresh-20-scale($scaleFactor: 1) {
  background-size: calc(1826px * #{$scaleFactor}) calc(52px * #{$scaleFactor});
  background-position: calc((-722px - 2px) * #{$scaleFactor}) calc((0px - 2px) * #{$scaleFactor});
  width: calc(40px * #{$scaleFactor});
  height: calc(40px * #{$scaleFactor});
}
...
@mixin oj-fwk-icon-pull-to-refresh-30-scale($scaleFactor: 1) {
  background-size: calc(1826px * #{$scaleFactor}) calc(52px * #{$scaleFactor});
  background-position: calc((-766px - 2px) * #{$scaleFactor}) calc((0px - 2px) * #{$scaleFactor});
  width: calc(40px * #{$scaleFactor});
  height: calc(40px * #{$scaleFactor});
}
...
@mixin oj-fwk-icon-pull-to-refresh-40-scale($scaleFactor: 1) {
  background-size: calc(1826px * #{$scaleFactor}) calc(52px * #{$scaleFactor});
  background-position: calc((-810px - 2px) * #{$scaleFactor}) calc((0px - 2px) * #{$scaleFactor});
  width: calc(40px * #{$scaleFactor});
  height: calc(40px * #{$scaleFactor});
}
...
@mixin oj-fwk-icon-pull-to-refresh-50-scale($scaleFactor: 1) {
  background-size: calc(1826px * #{$scaleFactor}) calc(52px * #{$scaleFactor});
  background-position: calc((-854px - 2px) * #{$scaleFactor}) calc((0px - 2px) * #{$scaleFactor});
  width: calc(40px * #{$scaleFactor});
  height: calc(40px * #{$scaleFactor});
}
...
@mixin oj-fwk-icon-pull-to-refresh-60-scale($scaleFactor: 1) {
  background-size: calc(1826px * #{$scaleFactor}) calc(52px * #{$scaleFactor});
  background-position: calc((-898px - 2px) * #{$scaleFactor}) calc((0px - 2px) * #{$scaleFactor});
  width: calc(40px * #{$scaleFactor});
  height: calc(40px * #{$scaleFactor});
}
...
@mixin oj-fwk-icon-pull-to-refresh-70-scale($scaleFactor: 1) {
  background-size: calc(1826px * #{$scaleFactor}) calc(52px * #{$scaleFactor});
  background-position: calc((-942px - 2px) * #{$scaleFactor}) calc((0px - 2px) * #{$scaleFactor});
  width: calc(40px * #{$scaleFactor});
  height: calc(40px * #{$scaleFactor});
}
...
@mixin oj-fwk-icon-pull-to-refresh-80-scale($scaleFactor: 1) {
  background-size: calc(1826px * #{$scaleFactor}) calc(52px * #{$scaleFactor});
  background-position: calc((-986px - 2px) * #{$scaleFactor}) calc((0px - 2px) * #{$scaleFactor});
  width: calc(40px * #{$scaleFactor});
  height: calc(40px * #{$scaleFactor});
}
...
@mixin oj-fwk-icon-pull-to-refresh-90-scale($scaleFactor: 1) {
  background-size: calc(1826px * #{$scaleFactor}) calc(52px * #{$scaleFactor});
  background-position: calc((-1030px - 2px) * #{$scaleFactor}) calc((0px - 2px) * #{$scaleFactor});
  width: calc(40px * #{$scaleFactor});
  height: calc(40px * #{$scaleFactor});
}
...
@mixin oj-fwk-icon-radio-dis-selected-scale($scaleFactor: 1) {
  background-size: calc(1826px * #{$scaleFactor}) calc(52px * #{$scaleFactor});
  background-position: calc((-1074px - 2px) * #{$scaleFactor}) calc((0px - 2px) * #{$scaleFactor});
  width: calc(48px * #{$scaleFactor});
  height: calc(48px * #{$scaleFactor});
}
...
@mixin oj-fwk-icon-radio-dis-unselected-scale($scaleFactor: 1) {
  background-size: calc(1826px * #{$scaleFactor}) calc(52px * #{$scaleFactor});
  background-position: calc((-1126px - 2px) * #{$scaleFactor}) calc((0px - 2px) * #{$scaleFactor});
  width: calc(48px * #{$scaleFactor});
  height: calc(48px * #{$scaleFactor});
}
...
@mixin oj-fwk-icon-radio-ena-selected-scale($scaleFactor: 1) {
  background-size: calc(1826px * #{$scaleFactor}) calc(52px * #{$scaleFactor});
  background-position: calc((-1178px - 2px) * #{$scaleFactor}) calc((0px - 2px) * #{$scaleFactor});
  width: calc(48px * #{$scaleFactor});
  height: calc(48px * #{$scaleFactor});
}
...
@mixin oj-fwk-icon-radio-ena-unselected-scale($scaleFactor: 1) {
  background-size: calc(1826px * #{$scaleFactor}) calc(52px * #{$scaleFactor});
  background-position: calc((-1230px - 2px) * #{$scaleFactor}) calc((0px - 2px) * #{$scaleFactor});
  width: calc(48px * #{$scaleFactor});
  height: calc(48px * #{$scaleFactor});
}
...
@mixin oj-fwk-icon-radio-pressed-selected-scale($scaleFactor: 1) {
  background-size: calc(1826px * #{$scaleFactor}) calc(52px * #{$scaleFactor});
  background-position: calc((-1282px - 2px) * #{$scaleFactor}) calc((0px - 2px) * #{$scaleFactor});
  width: calc(48px * #{$scaleFactor});
  height: calc(48px * #{$scaleFactor});
}
...
@mixin oj-fwk-icon-radio-pressed-unselected-scale($scaleFactor: 1) {
  background-size: calc(1826px * #{$scaleFactor}) calc(52px * #{$scaleFactor});
  background-position: calc((-1334px - 2px) * #{$scaleFactor}) calc((0px - 2px) * #{$scaleFactor});
  width: calc(48px * #{$scaleFactor});
  height: calc(48px * #{$scaleFactor});
}
...
@mixin oj-fwk-icon-spinner-00-scale($scaleFactor: 1) {
  background-size: calc(1826px * #{$scaleFactor}) calc(52px * #{$scaleFactor});
  background-position: calc((-1386px - 2px) * #{$scaleFactor}) calc((0px - 2px) * #{$scaleFactor});
  width: calc(40px * #{$scaleFactor});
  height: calc(40px * #{$scaleFactor});
}
...
@mixin oj-fwk-icon-spinner-10-scale($scaleFactor: 1) {
  background-size: calc(1826px * #{$scaleFactor}) calc(52px * #{$scaleFactor});
  background-position: calc((-1430px - 2px) * #{$scaleFactor}) calc((0px - 2px) * #{$scaleFactor});
  width: calc(40px * #{$scaleFactor});
  height: calc(40px * #{$scaleFactor});
}
...
@mixin oj-fwk-icon-spinner-20-scale($scaleFactor: 1) {
  background-size: calc(1826px * #{$scaleFactor}) calc(52px * #{$scaleFactor});
  background-position: calc((-1474px - 2px) * #{$scaleFactor}) calc((0px - 2px) * #{$scaleFactor});
  width: calc(40px * #{$scaleFactor});
  height: calc(40px * #{$scaleFactor});
}
...
@mixin oj-fwk-icon-spinner-30-scale($scaleFactor: 1) {
  background-size: calc(1826px * #{$scaleFactor}) calc(52px * #{$scaleFactor});
  background-position: calc((-1518px - 2px) * #{$scaleFactor}) calc((0px - 2px) * #{$scaleFactor});
  width: calc(40px * #{$scaleFactor});
  height: calc(40px * #{$scaleFactor});
}
...
@mixin oj-fwk-icon-spinner-40-scale($scaleFactor: 1) {
  background-size: calc(1826px * #{$scaleFactor}) calc(52px * #{$scaleFactor});
  background-position: calc((-1562px - 2px) * #{$scaleFactor}) calc((0px - 2px) * #{$scaleFactor});
  width: calc(40px * #{$scaleFactor});
  height: calc(40px * #{$scaleFactor});
}
...
@mixin oj-fwk-icon-spinner-50-scale($scaleFactor: 1) {
  background-size: calc(1826px * #{$scaleFactor}) calc(52px * #{$scaleFactor});
  background-position: calc((-1606px - 2px) * #{$scaleFactor}) calc((0px - 2px) * #{$scaleFactor});
  width: calc(40px * #{$scaleFactor});
  height: calc(40px * #{$scaleFactor});
}
...
@mixin oj-fwk-icon-spinner-60-scale($scaleFactor: 1) {
  background-size: calc(1826px * #{$scaleFactor}) calc(52px * #{$scaleFactor});
  background-position: calc((-1650px - 2px) * #{$scaleFactor}) calc((0px - 2px) * #{$scaleFactor});
  width: calc(40px * #{$scaleFactor});
  height: calc(40px * #{$scaleFactor});
}
...
@mixin oj-fwk-icon-spinner-70-scale($scaleFactor: 1) {
  background-size: calc(1826px * #{$scaleFactor}) calc(52px * #{$scaleFactor});
  background-position: calc((-1694px - 2px) * #{$scaleFactor}) calc((0px - 2px) * #{$scaleFactor});
  width: calc(40px * #{$scaleFactor});
  height: calc(40px * #{$scaleFactor});
}
...
@mixin oj-fwk-icon-spinner-80-scale($scaleFactor: 1) {
  background-size: calc(1826px * #{$scaleFactor}) calc(52px * #{$scaleFactor});
  background-position: calc((-1738px - 2px) * #{$scaleFactor}) calc((0px - 2px) * #{$scaleFactor});
  width: calc(40px * #{$scaleFactor});
  height: calc(40px * #{$scaleFactor});
}
...
@mixin oj-fwk-icon-spinner-90-scale($scaleFactor: 1) {
  background-size: calc(1826px * #{$scaleFactor}) calc(52px * #{$scaleFactor});
  background-position: calc((-1782px - 2px) * #{$scaleFactor}) calc((0px - 2px) * #{$scaleFactor});
  width: calc(40px * #{$scaleFactor});
  height: calc(40px * #{$scaleFactor});
}
