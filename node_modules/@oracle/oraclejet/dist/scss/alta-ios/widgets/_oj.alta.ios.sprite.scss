...
@mixin oj-fwk-icon-cbsingle-dis-selected-scale($scaleFactor: 1) {
  background-size: calc(1270px * #{$scaleFactor}) calc(44px * #{$scaleFactor});
  background-position: calc((0px - 2px) * #{$scaleFactor}) calc((0px - 2px) * #{$scaleFactor});
  width: calc(22px * #{$scaleFactor});
  height: calc(22px * #{$scaleFactor});
}

// Include this mixin in component SCSS if the image needs to be scaled.
@mixin oj-fwk-icon-cbsingle-dis-unselected-scale($scaleFactor: 1) {
  background-size: calc(1270px * #{$scaleFactor}) calc(44px * #{$scaleFactor});
  background-position: calc((-26px - 2px) * #{$scaleFactor}) calc((0px - 2px) * #{$scaleFactor});
  width: calc(22px * #{$scaleFactor});
  height: calc(22px * #{$scaleFactor});
}

// Include this mixin in component SCSS if the image needs to be scaled.
@mixin oj-fwk-icon-cbsingle-ena-selected-scale($scaleFactor: 1) {
  background-size: calc(1270px * #{$scaleFactor}) calc(44px * #{$scaleFactor});
...
// Include this mixin in component SCSS if the image needs to be scaled.
@mixin oj-fwk-icon-cbsingle-ena-unselected-scale($scaleFactor: 1) {
  background-size: calc(1270px * #{$scaleFactor}) calc(44px * #{$scaleFactor});
  background-position: calc((-78px - 2px) * #{$scaleFactor}) calc((0px - 2px) * #{$scaleFactor});
  width: calc(22px * #{$scaleFactor});
  height: calc(22px * #{$scaleFactor});
}
...
@mixin oj-fwk-icon-cbsingle-hover-unselected-scale($scaleFactor: 1) {
  background-size: calc(1270px * #{$scaleFactor}) calc(44px * #{$scaleFactor});
  background-position: calc((-130px - 2px) * #{$scaleFactor}) calc((0px - 2px) * #{$scaleFactor});
  width: calc(22px * #{$scaleFactor});
  height: calc(22px * #{$scaleFactor});
}

// Include this mixin in component SCSS if the image needs to be scaled.
@mixin oj-fwk-icon-cbsingle-pressed-selected-scale($scaleFactor: 1) {
  background-size: calc(1270px * #{$scaleFactor}) calc(44px * #{$scaleFactor});
...
// Include this mixin in component SCSS if the image needs to be scaled.
@mixin oj-fwk-icon-cbsingle-pressed-unselected-scale($scaleFactor: 1) {
  background-size: calc(1270px * #{$scaleFactor}) calc(44px * #{$scaleFactor});
  background-position: calc((-182px - 2px) * #{$scaleFactor}) calc((0px - 2px) * #{$scaleFactor});
  width: calc(22px * #{$scaleFactor});
  height: calc(22px * #{$scaleFactor});
}
...
@mixin oj-fwk-icon-checkbox-dis-selected-scale($scaleFactor: 1) {
  ...
  width: calc(14px * #{$scaleFactor});
  height: calc(13px * #{$scaleFactor});
}

// Include this mixin in component SCSS if the image needs to be scaled.
@mixin oj-fwk-icon-checkbox-ena-selected-scale($scaleFactor: 1) {
  background-size: calc(1270px * #{$scaleFactor}) calc(44px * #{$scaleFactor});
  background-position: calc((-226px - 2px) * #{$scaleFactor}) calc((0px - 2px) * #{$scaleFactor});
  width: calc(14px * #{$scaleFactor});
  height: calc(13px * #{$scaleFactor});
}
...
@mixin oj-fwk-icon-checkbox-tristate-partial-scale($scaleFactor: 1) {
  background-size: calc(1270px * #{$scaleFactor}) calc(44px * #{$scaleFactor});
  background-position: calc((-244px - 2px) * #{$scaleFactor}) calc((0px - 2px) * #{$scaleFactor});
  width: calc(22px * #{$scaleFactor});
  height: calc(22px * #{$scaleFactor});
}
...
@mixin oj-fwk-icon-checkbox-tristate-selected-scale($scaleFactor: 1) {
  background-size: calc(1270px * #{$scaleFactor}) calc(44px * #{$scaleFactor});
  background-position: calc((-270px - 2px) * #{$scaleFactor}) calc((0px - 2px) * #{$scaleFactor});
  width: calc(22px * #{$scaleFactor});
  height: calc(22px * #{$scaleFactor});
}
...
@mixin oj-fwk-icon-move-handle-scale($scaleFactor: 1) {
  background-size: calc(1270px * #{$scaleFactor}) calc(44px * #{$scaleFactor});
  background-position: calc((-322px - 2px) * #{$scaleFactor}) calc((0px - 2px) * #{$scaleFactor});
  width: calc(28px * #{$scaleFactor});
  height: calc(15px * #{$scaleFactor});
}

// Include this mixin in component SCSS if the image needs to be scaled.
@mixin oj-fwk-icon-pull-to-refresh-00-scale($scaleFactor: 1) {
  background-size: calc(1270px * #{$scaleFactor}) calc(44px * #{$scaleFactor});
  background-position: calc((-354px - 2px) * #{$scaleFactor}) calc((0px - 2px) * #{$scaleFactor});
  width: calc(40px * #{$scaleFactor});
  height: calc(40px * #{$scaleFactor});
}

// Include this mixin in component SCSS if the image needs to be scaled.
@mixin oj-fwk-icon-pull-to-refresh-10-scale($scaleFactor: 1) {
  background-size: calc(1270px * #{$scaleFactor}) calc(44px * #{$scaleFactor});
  background-position: calc((-398px - 2px) * #{$scaleFactor}) calc((0px - 2px) * #{$scaleFactor});
  width: calc(40px * #{$scaleFactor});
  height: calc(40px * #{$scaleFactor});
}

// Include this mixin in component SCSS if the image needs to be scaled.
@mixin oj-fwk-icon-pull-to-refresh-20-scale($scaleFactor: 1) {
  background-size: calc(1270px * #{$scaleFactor}) calc(44px * #{$scaleFactor});
  background-position: calc((-442px - 2px) * #{$scaleFactor}) calc((0px - 2px) * #{$scaleFactor});
  width: calc(40px * #{$scaleFactor});
  height: calc(40px * #{$scaleFactor});
}

// Include this mixin in component SCSS if the image needs to be scaled.
@mixin oj-fwk-icon-pull-to-refresh-30-scale($scaleFactor: 1) {
  background-size: calc(1270px * #{$scaleFactor}) calc(44px * #{$scaleFactor});
  background-position: calc((-486px - 2px) * #{$scaleFactor}) calc((0px - 2px) * #{$scaleFactor});
  width: calc(40px * #{$scaleFactor});
  height: calc(40px * #{$scaleFactor});
}

// Include this mixin in component SCSS if the image needs to be scaled.
@mixin oj-fwk-icon-pull-to-refresh-40-scale($scaleFactor: 1) {
  background-size: calc(1270px * #{$scaleFactor}) calc(44px * #{$scaleFactor});
  background-position: calc((-530px - 2px) * #{$scaleFactor}) calc((0px - 2px) * #{$scaleFactor});
  width: calc(40px * #{$scaleFactor});
  height: calc(40px * #{$scaleFactor});
}

// Include this mixin in component SCSS if the image needs to be scaled.
@mixin oj-fwk-icon-pull-to-refresh-50-scale($scaleFactor: 1) {
  background-size: calc(1270px * #{$scaleFactor}) calc(44px * #{$scaleFactor});
  background-position: calc((-574px - 2px) * #{$scaleFactor}) calc((0px - 2px) * #{$scaleFactor});
  width: calc(40px * #{$scaleFactor});
  height: calc(40px * #{$scaleFactor});
}

// Include this mixin in component SCSS if the image needs to be scaled.
@mixin oj-fwk-icon-pull-to-refresh-60-scale($scaleFactor: 1) {
  background-size: calc(1270px * #{$scaleFactor}) calc(44px * #{$scaleFactor});
  background-position: calc((-618px - 2px) * #{$scaleFactor}) calc((0px - 2px) * #{$scaleFactor});
  width: calc(40px * #{$scaleFactor});
  height: calc(40px * #{$scaleFactor});
}

// Include this mixin in component SCSS if the image needs to be scaled.
@mixin oj-fwk-icon-pull-to-refresh-70-scale($scaleFactor: 1) {
  background-size: calc(1270px * #{$scaleFactor}) calc(44px * #{$scaleFactor});
  background-position: calc((-662px - 2px) * #{$scaleFactor}) calc((0px - 2px) * #{$scaleFactor});
  width: calc(40px * #{$scaleFactor});
  height: calc(40px * #{$scaleFactor});
}

// Include this mixin in component SCSS if the image needs to be scaled.
@mixin oj-fwk-icon-pull-to-refresh-80-scale($scaleFactor: 1) {
  background-size: calc(1270px * #{$scaleFactor}) calc(44px * #{$scaleFactor});
  background-position: calc((-706px - 2px) * #{$scaleFactor}) calc((0px - 2px) * #{$scaleFactor});
  width: calc(40px * #{$scaleFactor});
  height: calc(40px * #{$scaleFactor});
}

// Include this mixin in component SCSS if the image needs to be scaled.
@mixin oj-fwk-icon-pull-to-refresh-90-scale($scaleFactor: 1) {
  background-size: calc(1270px * #{$scaleFactor}) calc(44px * #{$scaleFactor});
  background-position: calc((-750px - 2px) * #{$scaleFactor}) calc((0px - 2px) * #{$scaleFactor});
  width: calc(40px * #{$scaleFactor});
  height: calc(40px * #{$scaleFactor});
}
...
@mixin oj-fwk-icon-radio-dis-selected-scale($scaleFactor: 1) {
  background-size: calc(1270px * #{$scaleFactor}) calc(44px * #{$scaleFactor});
  background-position: calc((-794px - 2px) * #{$scaleFactor}) calc((0px - 2px) * #{$scaleFactor});
  width: calc(14px * #{$scaleFactor});
  height: calc(13px * #{$scaleFactor});
}
...
@mixin oj-fwk-icon-radio-ena-selected-scale($scaleFactor: 1) {
  background-size: calc(1270px * #{$scaleFactor}) calc(44px * #{$scaleFactor});
  background-position: calc((-812px - 2px) * #{$scaleFactor}) calc((0px - 2px) * #{$scaleFactor});
  width: calc(14px * #{$scaleFactor});
  height: calc(13px * #{$scaleFactor});
}
...
@mixin oj-fwk-icon-spinner-00-scale($scaleFactor: 1) {
  background-size: calc(1270px * #{$scaleFactor}) calc(44px * #{$scaleFactor});
  background-position: calc((-830px - 2px) * #{$scaleFactor}) calc((0px - 2px) * #{$scaleFactor});
  width: calc(40px * #{$scaleFactor});
  height: calc(40px * #{$scaleFactor});
}
...
@mixin oj-fwk-icon-spinner-10-scale($scaleFactor: 1) {
  background-size: calc(1270px * #{$scaleFactor}) calc(44px * #{$scaleFactor});
  background-position: calc((-874px - 2px) * #{$scaleFactor}) calc((0px - 2px) * #{$scaleFactor});
  width: calc(40px * #{$scaleFactor});
  height: calc(40px * #{$scaleFactor});
}
...
@mixin oj-fwk-icon-spinner-20-scale($scaleFactor: 1) {
  background-size: calc(1270px * #{$scaleFactor}) calc(44px * #{$scaleFactor});
  background-position: calc((-918px - 2px) * #{$scaleFactor}) calc((0px - 2px) * #{$scaleFactor});
  width: calc(40px * #{$scaleFactor});
  height: calc(40px * #{$scaleFactor});
}
...
@mixin oj-fwk-icon-spinner-30-scale($scaleFactor: 1) {
  background-size: calc(1270px * #{$scaleFactor}) calc(44px * #{$scaleFactor});
  background-position: calc((-962px - 2px) * #{$scaleFactor}) calc((0px - 2px) * #{$scaleFactor});
  width: calc(40px * #{$scaleFactor});
  height: calc(40px * #{$scaleFactor});
}
...
@mixin oj-fwk-icon-spinner-40-scale($scaleFactor: 1) {
  background-size: calc(1270px * #{$scaleFactor}) calc(44px * #{$scaleFactor});
  background-position: calc((-1006px - 2px) * #{$scaleFactor}) calc((0px - 2px) * #{$scaleFactor});
  width: calc(40px * #{$scaleFactor});
  height: calc(40px * #{$scaleFactor});
}
...
@mixin oj-fwk-icon-spinner-50-scale($scaleFactor: 1) {
  background-size: calc(1270px * #{$scaleFactor}) calc(44px * #{$scaleFactor});
  background-position: calc((-1050px - 2px) * #{$scaleFactor}) calc((0px - 2px) * #{$scaleFactor});
  width: calc(40px * #{$scaleFactor});
  height: calc(40px * #{$scaleFactor});
}
...
@mixin oj-fwk-icon-spinner-60-scale($scaleFactor: 1) {
  background-size: calc(1270px * #{$scaleFactor}) calc(44px * #{$scaleFactor});
  background-position: calc((-1094px - 2px) * #{$scaleFactor}) calc((0px - 2px) * #{$scaleFactor});
  width: calc(40px * #{$scaleFactor});
  height: calc(40px * #{$scaleFactor});
}
...
@mixin oj-fwk-icon-spinner-70-scale($scaleFactor: 1) {
  background-size: calc(1270px * #{$scaleFactor}) calc(44px * #{$scaleFactor});
  background-position: calc((-1138px - 2px) * #{$scaleFactor}) calc((0px - 2px) * #{$scaleFactor});
  width: calc(40px * #{$scaleFactor});
  height: calc(40px * #{$scaleFactor});
}
...
@mixin oj-fwk-icon-spinner-80-scale($scaleFactor: 1) {
  background-size: calc(1270px * #{$scaleFactor}) calc(44px * #{$scaleFactor});
  background-position: calc((-1182px - 2px) * #{$scaleFactor}) calc((0px - 2px) * #{$scaleFactor});
  width: calc(40px * #{$scaleFactor});
  height: calc(40px * #{$scaleFactor});
}
...
@mixin oj-fwk-icon-spinner-90-scale($scaleFactor: 1) {
  background-size: calc(1270px * #{$scaleFactor}) calc(44px * #{$scaleFactor});
  background-position: calc((-1226px - 2px) * #{$scaleFactor}) calc((0px - 2px) * #{$scaleFactor});
  width: calc(40px * #{$scaleFactor});
  height: calc(40px * #{$scaleFactor});
}
...
@if $includeIconClasses != false {
  @include module-include-once("alta.ios.sprite") {
    ...
    .oj-fwk-icon-cbsingle-dis-unselected {
      background-image: oj-image-url('sprites/sprite.svg');
      @include oj-fwk-icon-cbsingle-dis-unselected-scale;
    }

    // In high-contrast mode, background-image disappears, so we have to use content.
    .oj-hicontrast .oj-fwk-icon-cbsingle-dis-unselected {
      background-image: none;
    }
    .oj-hicontrast .oj-fwk-icon-cbsingle-dis-unselected:before {
      content: oj-image-url('cbsingle_dis_unselected.svg');
      width: 100%;
      height: 100%;
    }
    ...
    @media print, (max-resolution: .99dppx) {
      ...
      .oj-fwk-icon-cbsingle-dis-unselected:before {
        content: oj-image-url('cbsingle_dis_unselected.svg');
        width: 100%;
        height: 100%;
      }
    ...
    .oj-fwk-icon-cbsingle-ena-selected {
      background-image: oj-image-url('sprites/sprite.svg');
      @include oj-fwk-icon-cbsingle-ena-selected-scale;
    }

    // In high-contrast mode, background-image disappears, so we have to use content.
    .oj-hicontrast .oj-fwk-icon-cbsingle-ena-selected {
      background-image: none;
    }
    .oj-hicontrast .oj-fwk-icon-cbsingle-ena-selected:before {
    ...
    @media print, (max-resolution: .99dppx) {
      ...
      .oj-fwk-icon-cbsingle-ena-selected:before {
        content: oj-image-url('cbsingle_ena_selected.svg');
        width: 100%;
        height: 100%;
      }
    ...
    .oj-fwk-icon-cbsingle-ena-unselected {
      background-image: oj-image-url('sprites/sprite.svg');
      @include oj-fwk-icon-cbsingle-ena-unselected-scale;
    }

    // In high-contrast mode, background-image disappears, so we have to use content.
    .oj-hicontrast .oj-fwk-icon-cbsingle-ena-unselected {
      background-image: none;
    }
    .oj-hicontrast .oj-fwk-icon-cbsingle-ena-unselected:before {
      content: oj-image-url('cbsingle_ena_unselected.svg');
      width: 100%;
      height: 100%;
    }
    ...
    @media print, (max-resolution: .99dppx) {
      ...
      .oj-fwk-icon-cbsingle-ena-unselected:before {
        content: oj-image-url('cbsingle_ena_unselected.svg');
        width: 100%;
        height: 100%;
      }
    ...
    .oj-fwk-icon-cbsingle-pressed-selected {
      background-image: oj-image-url('sprites/sprite.svg');
      @include oj-fwk-icon-cbsingle-pressed-selected-scale;
    }

    // In high-contrast mode, background-image disappears, so we have to use content.
    .oj-hicontrast .oj-fwk-icon-cbsingle-pressed-selected {
      background-image: none;
    }
    .oj-hicontrast .oj-fwk-icon-cbsingle-pressed-selected:before {
      content: oj-image-url('cbsingle_pressed_selected.svg');
      width: 100%;
      height: 100%;
    }
    ...
    @media print, (max-resolution: .99dppx) {
      ...
      .oj-fwk-icon-cbsingle-pressed-selected:before {
        content: oj-image-url('cbsingle_pressed_selected.svg');
        width: 100%;
        height: 100%;
      }
    ...
    .oj-fwk-icon-cbsingle-pressed-unselected {
      background-image: oj-image-url('sprites/sprite.svg');
      @include oj-fwk-icon-cbsingle-pressed-unselected-scale;
    }

    // In high-contrast mode, background-image disappears, so we have to use content.
    .oj-hicontrast .oj-fwk-icon-cbsingle-pressed-unselected {
      background-image: none;
    }
    .oj-hicontrast .oj-fwk-icon-cbsingle-pressed-unselected:before {
      content: oj-image-url('cbsingle_pressed_unselected.svg');
      width: 100%;
      height: 100%;
    }
    ...
    @media print, (max-resolution: .99dppx) {
      ...
      .oj-fwk-icon-cbsingle-pressed-unselected:before {
        content: oj-image-url('cbsingle_pressed_unselected.svg');
        width: 100%;
        height: 100%;
      }
    ...
    .oj-fwk-icon-pull-to-refresh-00 {
      background-image: oj-image-url('sprites/sprite.svg');
      @include oj-fwk-icon-pull-to-refresh-00-scale;
    }

    // In high-contrast mode, background-image disappears, so we have to use content.
    .oj-hicontrast .oj-fwk-icon-pull-to-refresh-00 {
      background-image: none;
    }
    .oj-hicontrast .oj-fwk-icon-pull-to-refresh-00:before {
      content: oj-image-url('pull_to_refresh_00.svg');
      width: 100%;
      height: 100%;
    }
    ...
    @media print, (max-resolution: .99dppx) {
      ...
      .oj-fwk-icon-pull-to-refresh-00:before {
        content: oj-image-url('pull_to_refresh_00.svg');
        width: 100%;
        height: 100%;
      }
    ...
    .oj-fwk-icon-pull-to-refresh-10 {
      background-image: oj-image-url('sprites/sprite.svg');
      @include oj-fwk-icon-pull-to-refresh-10-scale;
    }

    // In high-contrast mode, background-image disappears, so we have to use content.
    .oj-hicontrast .oj-fwk-icon-pull-to-refresh-10 {
      background-image: none;
    }
    .oj-hicontrast .oj-fwk-icon-pull-to-refresh-10:before {
      content: oj-image-url('pull_to_refresh_10.svg');
      width: 100%;
      height: 100%;
    }
    ...
    @media print, (max-resolution: .99dppx) {
      ...
      .oj-fwk-icon-pull-to-refresh-10:before {
        content: oj-image-url('pull_to_refresh_10.svg');
        width: 100%;
        height: 100%;
      }
    ...
    .oj-fwk-icon-pull-to-refresh-20 {
      background-image: oj-image-url('sprites/sprite.svg');
      @include oj-fwk-icon-pull-to-refresh-20-scale;
    }

    // In high-contrast mode, background-image disappears, so we have to use content.
    .oj-hicontrast .oj-fwk-icon-pull-to-refresh-20 {
      background-image: none;
    }
    .oj-hicontrast .oj-fwk-icon-pull-to-refresh-20:before {
      content: oj-image-url('pull_to_refresh_20.svg');
      width: 100%;
      height: 100%;
    }
    ...
    @media print, (max-resolution: .99dppx) {
      ...
      .oj-fwk-icon-pull-to-refresh-20:before {
        content: oj-image-url('pull_to_refresh_20.svg');
        width: 100%;
        height: 100%;
      }
    ...
    .oj-fwk-icon-pull-to-refresh-30 {
      background-image: oj-image-url('sprites/sprite.svg');
      @include oj-fwk-icon-pull-to-refresh-30-scale;
    }

    // In high-contrast mode, background-image disappears, so we have to use content.
    .oj-hicontrast .oj-fwk-icon-pull-to-refresh-30 {
      background-image: none;
    }
    .oj-hicontrast .oj-fwk-icon-pull-to-refresh-30:before {
      content: oj-image-url('pull_to_refresh_30.svg');
      width: 100%;
      height: 100%;
    }
    ...
    @media print, (max-resolution: .99dppx) {
      ...
      .oj-fwk-icon-pull-to-refresh-30:before {
        content: oj-image-url('pull_to_refresh_30.svg');
        width: 100%;
        height: 100%;
      }
    ...
    .oj-fwk-icon-pull-to-refresh-40 {
      background-image: oj-image-url('sprites/sprite.svg');
      @include oj-fwk-icon-pull-to-refresh-40-scale;
    }

    // In high-contrast mode, background-image disappears, so we have to use content.
    .oj-hicontrast .oj-fwk-icon-pull-to-refresh-40 {
      background-image: none;
    }
    .oj-hicontrast .oj-fwk-icon-pull-to-refresh-40:before {
      content: oj-image-url('pull_to_refresh_40.svg');
      width: 100%;
      height: 100%;
    }
    ...
    @media print, (max-resolution: .99dppx) {
      ...
      .oj-fwk-icon-pull-to-refresh-40:before {
        content: oj-image-url('pull_to_refresh_40.svg');
        width: 100%;
        height: 100%;
      }
    ...
    .oj-fwk-icon-pull-to-refresh-50 {
      background-image: oj-image-url('sprites/sprite.svg');
      @include oj-fwk-icon-pull-to-refresh-50-scale;
    }

    // In high-contrast mode, background-image disappears, so we have to use content.
    .oj-hicontrast .oj-fwk-icon-pull-to-refresh-50 {
      background-image: none;
    }
    .oj-hicontrast .oj-fwk-icon-pull-to-refresh-50:before {
      content: oj-image-url('pull_to_refresh_50.svg');
      width: 100%;
      height: 100%;
    }
    ...
    @media print, (max-resolution: .99dppx) {
      ...
      .oj-fwk-icon-pull-to-refresh-50:before {
        content: oj-image-url('pull_to_refresh_50.svg');
        width: 100%;
        height: 100%;
      }
    ...
    .oj-fwk-icon-pull-to-refresh-60 {
      background-image: oj-image-url('sprites/sprite.svg');
      @include oj-fwk-icon-pull-to-refresh-60-scale;
    }

    // In high-contrast mode, background-image disappears, so we have to use content.
    .oj-hicontrast .oj-fwk-icon-pull-to-refresh-60 {
      background-image: none;
    }
    .oj-hicontrast .oj-fwk-icon-pull-to-refresh-60:before {
      content: oj-image-url('pull_to_refresh_60.svg');
      width: 100%;
      height: 100%;
    }
    ...
    @media print, (max-resolution: .99dppx) {
      ...
      .oj-fwk-icon-pull-to-refresh-60:before {
        content: oj-image-url('pull_to_refresh_60.svg');
        width: 100%;
        height: 100%;
      }
    ...
    .oj-fwk-icon-pull-to-refresh-70 {
      background-image: oj-image-url('sprites/sprite.svg');
      @include oj-fwk-icon-pull-to-refresh-70-scale;
    }

    // In high-contrast mode, background-image disappears, so we have to use content.
    .oj-hicontrast .oj-fwk-icon-pull-to-refresh-70 {
      background-image: none;
    }
    .oj-hicontrast .oj-fwk-icon-pull-to-refresh-70:before {
      content: oj-image-url('pull_to_refresh_70.svg');
      width: 100%;
      height: 100%;
    }
    ...
    @media print, (max-resolution: .99dppx) {
      ...
      .oj-fwk-icon-pull-to-refresh-70:before {
        content: oj-image-url('pull_to_refresh_70.svg');
        width: 100%;
        height: 100%;
      }
    ...
    .oj-fwk-icon-pull-to-refresh-80 {
      background-image: oj-image-url('sprites/sprite.svg');
      @include oj-fwk-icon-pull-to-refresh-80-scale;
    }

    // In high-contrast mode, background-image disappears, so we have to use content.
    .oj-hicontrast .oj-fwk-icon-pull-to-refresh-80 {
      background-image: none;
    }
    .oj-hicontrast .oj-fwk-icon-pull-to-refresh-80:before {
      content: oj-image-url('pull_to_refresh_80.svg');
      width: 100%;
      height: 100%;
    }
    ...
    @media print, (max-resolution: .99dppx) {
      ...
      .oj-fwk-icon-pull-to-refresh-80:before {
        content: oj-image-url('pull_to_refresh_80.svg');
        width: 100%;
        height: 100%;
      }
    ...
    .oj-fwk-icon-pull-to-refresh-90 {
      background-image: oj-image-url('sprites/sprite.svg');
      @include oj-fwk-icon-pull-to-refresh-90-scale;
    }

    // In high-contrast mode, background-image disappears, so we have to use content.
    .oj-hicontrast .oj-fwk-icon-pull-to-refresh-90 {
      background-image: none;
    }
    .oj-hicontrast .oj-fwk-icon-pull-to-refresh-90:before {
      content: oj-image-url('pull_to_refresh_90.svg');
      width: 100%;
      height: 100%;
    }
    ...
    @media print, (max-resolution: .99dppx) {
      ...
      .oj-fwk-icon-pull-to-refresh-90:before {
        content: oj-image-url('pull_to_refresh_90.svg');
        width: 100%;
        height: 100%;
      }
